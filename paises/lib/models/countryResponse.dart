...
CountryReponse countryReponseFromJson(String str) =>
    CountryReponse.fromJson(json.decode(str));

String countryReponseToJson(CountryReponse data) => json.encode(data.toJson());

class CountryReponse {
  CountryReponse({
    this.name,
    this.topLevelDomain,
    this.alpha2Code,
  ...
  factory CountryReponse.fromJson(Map<String, dynamic> json) => CountryReponse(
        name: json['name'],
